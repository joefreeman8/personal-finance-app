  ...
  return (
    <section className='mt-300 p-300 md:p-400 rounded-xl bg-white'>
      ...
      <div className='flex flex-col rounded-xl'>
        <div className='flex justify-between items-center w-full bg-beige100 rounded-lg mb-200 py-250 px-200 border-l-4 border-green'>
          <p className='text-grey500 text-preset-4'>Paid Bills</p>
          <p className='text-grey900 text-preset-4-bold'>$190.00</p>
        </div>
        <div className='flex justify-between items-center w-full bg-beige100 rounded-lg mb-200 py-250 px-200 border-l-4 border-yellow'>
          <p className='text-grey500 text-preset-4'>Total Upcoming</p>
          <p className='text-grey900 text-preset-4-bold'>$194.98</p>
        </div>
        <div className='flex justify-between items-center w-full bg-beige100 rounded-lg py-250 px-200 border-l-4 border-cyan'>
